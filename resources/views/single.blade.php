            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8 blog-content">
                        <img src="{{asset('assets/images/'.$cars->image)}}" alt="image" class="img-fluid p-3 mb-5 bg-white rounded">
                    ...
                    <div class="col-md-4 sidebar">
                        ...
                        <div class="sidebar-box">
                            <div class="categories">
                                ...
                                <li><a href="#">{{$cars->category->category}}</a></li>
                    ...
                    <div class="col-md-12">
                        <div class="border-top pt-5">
                            <p>
                                ...
                                </script> All rights reserved | This template is made with <i class="icon-heart text-danger" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">wafaa mostafa</a>
                                <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                            </p>
                        </div>
                    </div>
