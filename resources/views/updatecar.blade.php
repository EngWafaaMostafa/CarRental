                            ...
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    ...
                                    <form action="{{route('updatecar',$car->id)}}" method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
                                        ...
                                        <div class="item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3 label-align" for="image">Image :{{$car->image}}<span class="required">*</span>
                                            </label>
                                            <div class="col-md-6 col-sm-6 ">
                                                <input type="file" id="image" name="image" required="required" class="form-control">


                                                <img src="{{asset('assets/images/'.$car->image)}}" alt="image" style="width: 300px;">
