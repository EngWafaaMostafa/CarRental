                        ...
                        <div class="menu_section">
                            ...
                            <ul class="nav side-menu">
                                ...
                                <li><a><i class="fa fa-desktop"></i> Testimonials <span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu">
                                        <li><a href="{{route('addtestmonial')}}">Add Testimonials</a></li>
                                        <li><a href="{{route('testmonials')}}">Edit Testimonials</a></li>
                                    </ul>
                                </li>
                        ...
                        <ul class=" navbar-right">
                            <li class="nav-item dropdown open" style="padding-left: 15px;">
                                <a href="javascript:;" class="user-profile dropdown-toggle" aria-haspopup="true" id="navbarDropdown" data-toggle="dropdown" aria-expanded="false">
                                    <img src="{{asset('admin/images/img.jpg')}}" alt="">{{$fname}}
                                </a>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 ">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    <br />
                                    <form action="{{route('updatetestmonial',$testmonial->id)}}" method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
                                        @csrf
                                        @method('put')
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 ">
                                                <input type="text" id="name" required="required" class="form-control " name="name" value="{{$testmonial->name}}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 ">
                                                <input type="text" id="position" required="required" class="form-control " name="position" value="{{$testmonial->position}}">
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 ">
                                                <textarea id="content" name="content" required="required" class="form-control">{{$testmonial->content}}</textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="checkbox">
                                                <label>
                                                    <input type="checkbox" class="flat" name="published" @checked($testmonial->published)>
                                                </label>
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 ">
                                                ...
                                                <img src="{{asset('assets/images/'.$testmonial->image)}}" alt="image" style="width: 300px;">
                                                <input type="hidden" name="oldImage" value="{{$testmonial->image}}">
                                            </div>
                                        </div>
